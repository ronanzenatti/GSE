...
class Trabalho_model extends MY_Model
{
    public function __construct()
    {
        ...
        $this->column_order = array('t.id_trabalho','t.adolescente_id','t.empresa','t.salario','t.dt_inicio','t.horario_inicio','t.horario_fim','t.dt_recisao','t.obs','t.motivo_recisao','t.tipo');
        ...
        $this->joins = array(
			['tabela' => 'adolescentes a', 'juncao' => 'a.id_adolescente = t.adolescente_id', 'tipo' => 'INNER']
		);
    }
}
