...
CREATE TABLE `grupos_familiares` (
  `id_grupo_familiare` bigint(20) UNSIGNED NOT NULL,
  `adolescente_id` bigint(20) UNSIGNED NOT NULL,
...
ALTER TABLE `grupos_familiares`
  ADD PRIMARY KEY (`id_grupo_familiare`),
...
--
ALTER TABLE `grupos_familiares`
  MODIFY `id_grupo_familiare` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `beneficios_familias`
  ADD CONSTRAINT `fk_grupo_beneficio` FOREIGN KEY (`grupo_familiar_id`) REFERENCES `grupos_familiares` (`id_grupo_familiare`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Restrições para tabelas `composicao_familiar`
--
ALTER TABLE `composicao_familiar`
  ADD CONSTRAINT `fk_grupo_familia_composicao_familiar` FOREIGN KEY (`grupo_familiar_id`) REFERENCES `grupos_familiares` (`id_grupo_familiare`) ON DELETE NO ACTION ON UPDATE NO ACTION;
