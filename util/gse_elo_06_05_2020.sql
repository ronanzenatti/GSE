...
--
-- Host: 127.0.0.1
-- Tempo de geração: 06-Maio-2020 às 19:16
...
(1, 1, 'entidades', 'C', 1, NULL, '{\"nome\":\"ETEC de Ibitinga\",\"cnpj\":\"62.823.257\\/0161-02\",\"tipo\":\"R\",\"logradouro\":\"Rua Rosalbino Tucci\",\"numero\":\"431\",\"bairro\":\"Centro\",\"cidade\":\"Ibitinga\",\"estado\":\"SP\",\"cep\":\"14.940-000\",\"telefones\":\"(16) 3341-7046 \\/ 3342-6039\",\"email\":\"e161dir@cps.sp.gov.br\",\"responsavel\":\"Patricia\",\"resp_tel\":\"(16) 3341-7046\",\"resp_email\":\"e161dir@cps.sp.gov.br\",\"created_at\":\"2020-05-06 14:10:46\",\"updated_at\":\"2020-05-06 14:10:46\"}', '::1', '2020-05-06 14:10:46', NULL),
(2, 1, 'cargos', 'C', 1, NULL, '{\"nome\":\"Administrador\",\"descricao\":\"Administrador do Sistema\",\"created_at\":\"2020-05-06 14:10:46\",\"updated_at\":\"2020-05-06 14:10:46\"}', '::1', '2020-05-06 14:10:46', NULL),
(3, 1, 'funcionarios', 'C', 1, NULL, '{\"nome\":\"Ronan Adriel Zenatti\",\"dt_nasc\":\"1988-02-25\",\"sexo\":\"M\",\"cpf\":\"355.936.478-79\",\"rg\":\"41.324.990-6\",\"registro\":\"57852\",\"logradouro\":\"Rua dos Lavradores\",\"numero\":\"302\",\"bairro\":\"Centro\",\"cidade\":\"Boracéia\",\"estado\":\"SP\",\"cep\":\"17.270-000\",\"telefones\":\"(14) 9 8157-5657\",\"obs\":\"Cadastro Automático.\",\"entidade_id\":1,\"created_at\":\"2020-05-06 14:10:46\",\"updated_at\":\"2020-05-06 14:10:46\"}', '::1', '2020-05-06 14:10:46', NULL),
(4, 1, 'termos_compromissos', 'C', 1, NULL, '{\"nome\":\"Termo do Administrador\",\"texto\":\"Termo para o Administrador do Sistema\",\"created_at\":\"2020-05-06 14:10:46\",\"updated_at\":\"2020-05-06 14:10:46\"}', '::1', '2020-05-06 14:10:46', NULL),
(5, 1, 'usuarios', 'C', 1, NULL, '{\"ip_address\":\"::1\",\"cargo_id\":1,\"termo_id\":1,\"email\":\"ronan.zenatti@etec.sp.gov.br\",\"password\":\"$2y$08$ZMVJ6ITGMJNHOZKgk1TN6.7jWvdsm2UMA0lRjbF.kyfsZym4BZE2u\",\"active\":1,\"funcionario_id\":1,\"data_termo\":\"2020-05-06 14:10:46\",\"created_at\":\"2020-05-06 14:10:46\",\"updated_at\":\"2020-05-06 14:10:46\"}', '::1', '2020-05-06 14:10:46', NULL),
(6, 2, 'funcionarios', 'C', 1, NULL, '{\"nome\":\"USUARIO SEM TERMO\",\"dt_nasc\":\"1999-01-01\",\"sexo\":\"M\",\"logradouro\":\"\",\"numero\":\"\",\"bairro\":\"\",\"cidade\":\"Ibitinga\",\"estado\":\"SP\",\"cep\":\"\",\"telefones\":\"\",\"obs\":\"\",\"entidade_id\":\"1\",\"created_at\":\"2020-05-06 14:13:22\",\"updated_at\":\"2020-05-06 14:13:22\"}', '::1', '2020-05-06 14:13:22', NULL),
(7, 2, 'usuarios', 'C', 1, NULL, '{\"ip_address\":\"::1\",\"cargo_id\":\"1\",\"termo_id\":\"1\",\"email\":\"teste@teste.com\",\"password\":\"$2y$08$gxNjN9TL2hDCgewPWAIh7.2vMdR\\/wDOqlwvokGLUC5XCyZQhhk3Ri\",\"active\":1,\"data_termo\":null,\"created_at\":\"2020-05-06 14:13:22\",\"updated_at\":\"2020-05-06 14:13:22\",\"funcionario_id\":2}', '::1', '2020-05-06 14:13:23', NULL);
...
(1, 'Administrador', 'Administrador do Sistema', '2020-05-06 14:10:46', '2020-05-06 14:10:46', NULL);
...
(1, 'ETEC de Ibitinga', '62.823.257/0161-02', 'R', 'Rua Rosalbino Tucci', '431', 'Centro', 'Ibitinga', 'SP', '14.940-000', '(16) 3341-7046 / 3342-6039', 'e161dir@cps.sp.gov.br', 'Patricia', '(16) 3341-7046', 'e161dir@cps.sp.gov.br', '2020-05-06 14:10:46', '2020-05-06 14:10:46', NULL);
...
(1, 1, 'Ronan Adriel Zenatti', '1988-02-25', 'M', '355.936.478-79', '41.324.990-6', '57852', 'Rua dos Lavradores', '302', 'Centro', 'Boracéia', 'SP', '17.270-000', '(14) 9 8157-5657', 'Cadastro Automático.', '2020-05-06 14:10:46', '2020-05-06 14:10:46', NULL),
(2, 1, 'USUARIO SEM TERMO', '1999-01-01', 'M', NULL, NULL, NULL, '', '', '', 'Ibitinga', 'SP', '', '', '', '2020-05-06 14:13:22', '2020-05-06 14:13:22', NULL);
...
(1, 1, '::1', 'Chrome / 81.0.4044.129', 'Windows', '2020-05-06 14:11:17', NULL),
(2, 2, '::1', 'Chrome / 81.0.4044.129', 'Windows', '2020-05-06 14:13:41', NULL);
...
--
-- Estrutura da tabela `termos_compromissos`
--

CREATE TABLE `termos_compromissos` (
  `id_termo` bigint(20) UNSIGNED NOT NULL,
  `nome` varchar(191) NOT NULL,
...
--
-- Extraindo dados da tabela `termos_compromissos`
--

INSERT INTO `termos_compromissos` (`id_termo`, `nome`, `texto`, `created_at`, `updated_at`, `deleted_at`) VALUES
(1, 'Termo do Administrador', 'Termo para o Administrador do Sistema', '2020-05-06 14:10:46', '2020-05-06 14:10:46', NULL);
...
CREATE TABLE `usuarios` (
  ...
  `termo_id` bigint(20) UNSIGNED NOT NULL,
  `ip_address` varchar(45) NOT NULL,
  ...
  `user_validate_id` bigint(20) UNSIGNED NOT NULL,
  `created_at` datetime DEFAULT NULL,
  `updated_at` datetime DEFAULT NULL,
  `deleted_at` datetime DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
INSERT INTO `usuarios` (`id_usuario`, `funcionario_id`, `cargo_id`, `termo_id`, `ip_address`, `salt`, `email`, `password`, `username`, `activation_code`, `forgotten_password_code`, `forgotten_password_time`, `remember_code`, `last_login`, `active`, `data_termo`, `user_validate_id`, `created_at`, `updated_at`, `deleted_at`) VALUES
(1, 1, 1, 1, '::1', NULL, 'ronan.zenatti@etec.sp.gov.br', '$2y$08$ZMVJ6ITGMJNHOZKgk1TN6.7jWvdsm2UMA0lRjbF.kyfsZym4BZE2u', NULL, NULL, NULL, NULL, NULL, 1588785077, 1, '2020-05-06 14:10:46', 0, '2020-05-06 14:10:46', '2020-05-06 14:10:46', NULL),
(2, 2, 1, 1, '::1', NULL, 'teste@teste.com', '$2y$08$gxNjN9TL2hDCgewPWAIh7.2vMdR/wDOqlwvokGLUC5XCyZQhhk3Ri', NULL, NULL, NULL, NULL, NULL, 1588785222, 1, NULL, 0, '2020-05-06 14:13:22', '2020-05-06 14:13:22', NULL);
...
--
-- Índices para tabela `termos_compromissos`
--
ALTER TABLE `termos_compromissos`
...
ALTER TABLE `usuarios`
  ...
  ADD KEY `fk_usuario_termo_idx` (`termo_id`);
...
--
ALTER TABLE `historico_logins`
  MODIFY `id_hl` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
...
--
-- AUTO_INCREMENT de tabela `termos_compromissos`
--
ALTER TABLE `termos_compromissos`
  MODIFY `id_termo` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
ALTER TABLE `usuarios`
  ...
  ADD CONSTRAINT `fk_usuario_termo` FOREIGN KEY (`termo_id`) REFERENCES `termos_compromissos` (`id_termo`) ON DELETE NO ACTION ON UPDATE NO ACTION;
COMMIT;
